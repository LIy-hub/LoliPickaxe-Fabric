...
| Functional blocks | 9 | Three effect TNT blocks, Loli Altar, Password Workbench | Three TNT blocks and exact 63x63 altar complete; password workbench pending |
...
| Client screens and networking | 12 | Config, enchantment, potion, folding, storage, blacklist and password screens plus payloads | Safe TNT payload and two bounded responsive screens complete; remaining utility screens pending |
