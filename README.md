...
> A Fabric 1.20.5 memorial port of the classic LoliPickaxe mod.
...
LoliPickaxe is a Fabric mod for Minecraft 1.20.5. It adds the Loli Pickaxe, an
...
LoliPickaxe（氪金萝莉）是经典 LoliPickaxe 模组的 Minecraft 1.20.5
